...
class DeprecatedClass:
    ...
    def __init__(self):
        warn_deprecated(
            "0.3.0", DeprecatedType.CLASS, "DeprecatedClass", DeprecatedType.CLASS, "NewClass"
        )
...
@ddt
class TestDeprecation(QiskitOptimizationTestCase):
    ...
    def test_class_deprecation(self):
        ...
        msg_ref = (
            "The DeprecatedClass class is deprecated as of version 0.3.0 "
            "and will be removed no sooner than 3 months after the release. "
