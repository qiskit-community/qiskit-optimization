...
class TestQuadraticConstraint(QiskitOptimizationTestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[0].sense, Constraint.Sense.EQ
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[0].evaluate(linear_coeffs), 0.0
        )
        ...
        quadratic_program.quadratic_constraint(
            linear_coeffs, quadratic_coeffs, "==", 1.0, "q1"
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[1].sense, Constraint.Sense.EQ
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[1].evaluate(linear_coeffs), 930.0
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[2].sense, Constraint.Sense.GE
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[2].evaluate(linear_coeffs), 0.0
        )
        ...
        quadratic_program.quadratic_constraint(
            linear_coeffs, quadratic_coeffs, ">=", 1.0, "q3"
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[3].sense, Constraint.Sense.GE
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[3].evaluate(linear_coeffs), 930.0
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[4].sense, Constraint.Sense.LE
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[4].evaluate(linear_coeffs), 0.0
        )
        ...
        quadratic_program.quadratic_constraint(
            linear_coeffs, quadratic_coeffs, "<=", 1.0, "q5"
        )
        ...
        self.assertEqual(
            quadratic_program.quadratic_constraints[5].sense, Constraint.Sense.LE
        )
