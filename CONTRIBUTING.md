...
we document that when we release a new version of qiskit-optimization. The expectation
...
use the ``reno report`` command. If you want to generate the full Optimization release
...
https://github.com/Qiskit/qiskit-optimization/blob/main/docs/release_notes.rst)
...
Test section. However please note Optimization does not have any
...
The main branch is used for development of the next version of qiskit-optimization.
...
qiskit-optimization. It contains the versions of the code corresponding to the minor
...
From time to time, we will release brand new versions of Qiskit Optimization. These
