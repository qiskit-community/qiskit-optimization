...
class QuadraticProgram:
    ...
    def from_model(
        self, model: Model, translator: Optional[ModelTranslator] = None
    ) -> None:
    ...
    def from_docplex(self, model: Model) -> None:
        ...
        Raises:
            QiskitOptimizationError: if the model contains unsupported elements.
        """
        # warnings.warn("The from_docplex method is deprecated and will be "
        #               "removed in a future release. Instead use the"
        #               "from_model() method", DeprecationWarning)
