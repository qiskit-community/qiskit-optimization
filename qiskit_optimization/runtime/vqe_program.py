...
class VQEProgram(VQERuntimeClient):
    ...
    def __init__(
        ...
        warnings.warn(
            "The qiskit_optimization.runtime.VQEProgram has been renamed to "
            "qiskit_optimization.runtime.VQERuntimeClient to reflect it is a client for a program "
...
class VQEProgramResult(VQERuntimeResult):
    ...
    def __init__(self) -> None:
        super().__init__()
        warnings.warn(
            "The qiskit_optimization.runtime.VQEProgramResult has been renamed to "
            "qiskit_optimization.runtime.VQERuntimeResult to reflect it is a result from a runtime "
